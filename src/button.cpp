...
Button::Button(byte attachTo, byte buttonMode, unsigned int debounceTimeout)
{
    pin = attachTo;
...
unsigned int Button::wasPressedFor() {
  return down_time_ms;
}
...
unsigned int Button::getNumberOfClicks() {
    return click_count;
}

/////////////////////////////////////////////////////////////////

unsigned int Button::getClickType() {
