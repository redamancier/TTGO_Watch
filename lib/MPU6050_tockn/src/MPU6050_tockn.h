...
class MPU6050{
  ...
  float getGyroX(){ return my_gyrox; };
  float getGyroY(){ return my_gyroy; };
  float getGyroZ(){ return my_gyroz; };
  ...
  float my_gyroXoffset, my_gyroYoffset, my_gyroZoffset;

  float temp, accX, accY, accZ, gyroX, gyroY, gyroZ;

  float my_accx, my_accy, my_accz, my_gyrox, my_gyroy, my_gyroz;
